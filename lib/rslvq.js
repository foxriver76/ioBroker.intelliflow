...
class RSLVQ {
    ...
    async updateProtoypeAdamax(y, label, x, protoIdx) {
        ...
        // Todo: we need np.maximum here
        this.pastSquaredGradientsV[label][protoIdx] = nj.max(nj.multiply(broadcastedBeta2, this.pastSquaredGradientsV[label][protoIdx]), nj.abs(gradient));
